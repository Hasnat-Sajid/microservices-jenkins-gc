...
/**
 * The SensorRequest class represents a data transfer object (DTO) for creating or
 * updating sensor information in the Sensor Service application. It encapsulates the
 * attributes necessary for defining a sensor, including its name, location, activity status,
 * and sensor type.
 *
